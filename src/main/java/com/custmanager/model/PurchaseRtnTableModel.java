 ...
 * @author Inderjit
 */
public class PurchaseRtnTableModel extends AbstractTableModel {
    private static final long serialVersionUID = 1L;

    private String[] columnNames;
    private ArrayList<ElegantBuySell> data;

    public PurchaseRtnTableModel(String[] colNames, ArrayList<ElegantBuySell> tableData) {
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            ...
            case 3:
                ...
                break;
            case 4:
                value = buySell.getBuyerSellBillNo();
                break;
            case 5:
