 ...
 * @author Inderjit
 */
public class SalesRtnDetailsTableModel extends AbstractTableModel {
    ...
    public SalesRtnDetailsTableModel(String[] colNames, ArrayList<ElegantBuySellDetails> tableData) {
    ...
    public void setValueAt(Object val, int row, int col) {
        ...
        switch (col) {
            ...
            case 4:
                ...
                break;
            case 5:
                if (val instanceof String) buySell.setBilledRtnQty(Double.parseDouble((String) val));
                break;
            case 6:
                if (val instanceof String) {
