 ...
 * @author Inderjit
 */
public class PurchaseDetailsTableModel extends AbstractTableModel {
    ...
    public PurchaseDetailsTableModel(String[] colNames, ArrayList<ElegantBuySellDetails> tableData) {
    ...
    public void setValueAt(Object val, int row, int col) {
        ...
        switch (col) {
            ...
            case 4:
                ...
                buySell.setUnitAmt((buySell.getPurchQty() * buySell.getPurchRate()) - buySell.getUnitDiscount());
                break;
            case 5:
                if (val instanceof String) {
